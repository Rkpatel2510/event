	...
	<div class="container py-lg-5 py-3">
		...
		<div class="row portfolio-area">
			...
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup9" >
						<img src="images/g9.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup10" >
						<img src="images/g10.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup11" >
						<img src="images/g11.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup12" >
						<img src="images/g12.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
