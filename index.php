		...
		<div class="banner-text">
			<div class="slider-info mb-4">
				<div class="banner-heading">
					<h3>
						Your special day adventure starts here
					</h3>
				</div>
				<a href="contact.php"> Plan Your Special day</a>
			</div>
			<!-- To bottom button-->
...
<section class="welcome py-5" id="welcome">
	<div class="container py-md-5">
		<h3 class="heading text-capitalize text-center mb-lg-5 mb-4"> we will plan every detail of your event </h3>
		<div class="row welcome-grids">
			<div class="col-lg-4 mb-lg-0 mb-5">
				<h4 class="left-heading">Our Events Story</h4>
...
<section class="section my-lg-5 py-5">
	<div class="container py-md-5">
		<h3 class="heading wedding text-light mb-2 text-center">Our Next Event Organized Is On</h3>
		...
		<div class="row">
			<div class="col-lg-7 mx-auto">
				...
				<div class="examples text-center">
					<h4>21 Dec, 2022.</h4>
					<p>Venue : 2466H 5th Street Parking, King Block, India.</p>
				</div>
				<!--//date-->
			</div>
...
<section class="subscribe text-center bg-light py-5">
	<div class="container p-sm-3">
		...
		<a class="btn btn-info btn-lg-block w3ls-btn px-sm-4 px-3 text-capitalize mr-sm-2" href="Registration.php">Signup and recieve your First Plan.</a>
	</div>
</section>
<!-- //subscribe -->
