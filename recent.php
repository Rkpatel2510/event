	...
	<div class="container">
        ...
        <input type="checkbox" id="drop" />
            <ul class="menu mt-2">
				...
				<li class="mr-lg-3 mr-2 active"><a href="recent.php">Recent Events</a></li>
                <li class="mr-lg-3 mr-2"><a href="contact.php">Contact</a></li>
            </ul>
        </nav>
		<!-- //nav -->
	</div>
...
<section class="wthree-row w3-gallery py-sm-5 py-3" id="gallery">
	<div class="container py-lg-5 py-3">
		<h3 class="heading text-center mb-lg-5 mb-4">Recent Event</h3>
		<div class="row portfolio-area">
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class href="#popup1" >
						<img src="images/v1.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup2" >
						<img src="images/v2.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup3" >
						<img src="images/v3.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup4" >
						<img src="images/v4.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup5" >
						<img src="images/v5.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup6" >
						<img src="images/v6.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup7" >
						<img src="images/v7.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup8" >
						<img src="images/v8.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup9" >
						<img src="images/v9.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup10" >
						<img src="images/v10.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup11" >
						<img src="images/v11.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
			<div class="col-md-3 col-sm-6 p-1">
				<div class="portfolio-item2">
					<a class="" href="#popup12" >
						<img src="images/v12.jpg" class="img-fluid w3layouts agileits" alt="Wedding">
					</a>
				</div>
			</div>
...
<div id="popup1" class="popup-effect">
	<div class="popup">
		<img src="images/v1.jpg" alt="Popup Image" class="img-fluid">
...
<div id="popup2" class="popup-effect">
	<div class="popup">
		<img src="images/v2.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
	</div>
...
<div id="popup3" class="popup-effect">
	<div class="popup">
		<img src="images/v3.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup4" class="popup-effect">
	<div class="popup">
		<img src="images/v4.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup5" class="popup-effect">
	<div class="popup">
		<img src="images/v5.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup6" class="popup-effect">
	<div class="popup">
		<img src="images/v6.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup7" class="popup-effect">
	<div class="popup">
		<img src="images/v7.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup8" class="popup-effect">
	<div class="popup">
		<img src="images/v8.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup9" class="popup-effect">
	<div class="popup">
		<img src="images/v9.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup10" class="popup-effect">
	<div class="popup">
		<img src="images/v10.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup11" class="popup-effect">
	<div class="popup">
		<img src="images/v11.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
...
<div id="popup12" class="popup-effect">
	<div class="popup">
		<img src="images/v12.jpg" alt="Popup Image" class="img-fluid">
		<a class="close" href="#gallery"></a>
	</div>
</div>
